...
export class MyBg extends LitElement {
  ...
  render() {
    return html`
      <style>
        :host {
          --bg-1-opacity: ${this.openCardName === "cardone" ? "1" : "0"};
          --bg-2-opacity: ${this.openCardName === "cardtwo" ? "1" : "0"};
          --bg-3-opacity: ${this.openCardName === "cardthree"
            ? "1"
            : "0"};
          --bg-4-opacity: ${this.openCardName === "cardfour" ? "1" : "0"};
        }
      </style>
